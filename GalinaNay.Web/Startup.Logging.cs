namespace GalinaNay.Web
{
	...
	public partial class Startup
    {
        ...
        /// stored.</param>
        private static void ConfigureLogging(IApplicationBuilder application, IHostingEnvironment environment, ILoggerFactory loggerFactory, IConfiguration configuration)
        {
