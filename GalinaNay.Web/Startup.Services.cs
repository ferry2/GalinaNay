...
{
	using GalinaNay.Web.Services.BrowserConfig;
#if DNX451
	using GalinaNay.Web.Services.Feed;
#endif
	using GalinaNay.Web.Services.Manifest;
	using GalinaNay.Web.Services.OpenSearch;
	using GalinaNay.Web.Services.Robots;
	using GalinaNay.Web.Services.Sitemap;
	using GalinaNay.Web.Services.SitemapPinger;
