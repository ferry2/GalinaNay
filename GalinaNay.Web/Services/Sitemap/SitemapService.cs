namespace GalinaNay.Web.Services.Sitemap
{
	using System;
	...
	public class SitemapService : SitemapGenerator, ISitemapService
    {
        ...
        {
            var cacheProfile = cacheProfileSettings.Value.CacheProfiles[CacheProfileName.SitemapNodes];
