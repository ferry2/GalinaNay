namespace GalinaNay.Web.Services.BrowserConfig
{
	using System.Text;
	...
	public class BrowserConfigService : IBrowserConfigService
    {
        ...
        public string GetBrowserConfigXml()
        {
            ...
            var square70x70logoUrl = this.urlHelper.Content("~/img/icons/mstile-70x70.png");
            // The URL to the 150x150 medium tile image.
            var square150x150logoUrl = this.urlHelper.Content("~/img/icons/mstile-150x150.png");
            // The URL to the 310x310 large tile image.
            var square310x310logoUrl = this.urlHelper.Content("~/img/icons/mstile-310x310.png");
            // The URL to the 310x150 wide tile image.
            var wide310x150logoUrl = this.urlHelper.Content("~/img/icons/mstile-310x150.png");
        ...
        private string GetTileUrl(int feedEntry)
        {
            ...
            return
	            $"http://notifications.buildmypinnedsite.com/?feed={this.urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetFeed)}&amp;id={feedEntry}";
        }
    }
}
