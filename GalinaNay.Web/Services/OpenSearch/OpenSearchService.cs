namespace GalinaNay.Web.Services.OpenSearch
{
	using System.Text;
	...
	public sealed class OpenSearchService : IOpenSearchService
    {
        ...
        public OpenSearchService(IOptions<AppSettings> appSettings, IUrlHelper urlHelper)
        {
        ...
        public string GetOpenSearchXml()
        {
            ...
            // defined query.
            var searchUrl = this.urlHelper.AbsoluteRouteUrl(
            ...
            var searchFormUrl = this.urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetIndex);
            // The link to the favicon.ico file for the site.
            var favicon16Url = this.urlHelper.AbsoluteContent("~/favicon.ico");
            // The link to the favicon.png file for the site.
            var favicon32Url = this.urlHelper.AbsoluteContent("~/img/icons/favicon-32x32.png");
            // The link to the favicon.png file for the site.
            var favicon96Url = this.urlHelper.AbsoluteContent("~/img/icons/favicon-96x96.png");
