...
namespace GalinaNay.Web.Services.Feed
{
	using System;
	...
	public sealed class FeedService : IFeedService
    {
        ...
        /// </summary>
        private const string FeedId = "4E8D0845-463C-4752-AEBC-20057F7E6586";
...
#region Constructors
        ...
        public FeedService(IOptions<AppSettings> appSettings, IUrlHelper urlHelper)
        {
        ...
        public async Task<SyndicationFeed> GetFeed(CancellationToken cancellationToken)
        {
            var feed = new SyndicationFeed()
            {
                ...
                Copyright = SyndicationContent.CreatePlaintextContent(
	                $"© {DateTime.Now.Year} - {this.appSettings.Value.SiteTitle}"),
...
#region Private Methods
        ...
        private IEnumerable<SyndicationItem> GetItems(CancellationToken cancellationToken)
        {
            ...
            for (var i = 1; i < 4; ++i)
            {
                var item = new SyndicationItem()
                {
                    ...
                    Copyright = new TextSyndicationContent($"© {DateTime.Now.Year} - {this.appSettings.Value.SiteTitle}"),
                };
                ...
                item.Links.Add(SyndicationLink.CreateMediaEnclosureLink(new Uri(this.urlHelper.AbsoluteContent("~/img/icons/atom-icon-48x48.png")), ContentType.Png, 0));
